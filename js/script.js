...
const IMG_VIEW_ARRAY = [
    ...
    document.getElementById('img-view-5'),
    document.getElementById('img-view-6'),
    document.getElementById('img-view-7'),
    document.getElementById('img-view-8')
]
...
const MODAL_DETAIL_ARRAY = [
    ...
    document.getElementById('modal-detail-5'),
    document.getElementById('modal-detail-6'),
    document.getElementById('modal-detail-7'),
    document.getElementById('modal-detail-8')
]
